...
export default function OrganizationView() {
  ...
  return (
    <main className="p-4 md:p-8 h-screen flex flex-col overflow-hidden">
      <h1 className="text-2xl font-semibold mb-6">{org.title}</h1>

      {/* Tab bar */}
      <div className="flex border-b border-border mb-6" role="tablist" aria-label={org.title}>
        <button
          role="tab"
          type="button"
          aria-selected={activeTab === 'apiKeys'}
          aria-controls="tab-panel-apikeys"
          id="tab-apikeys"
        ...
        <button
          ...
          aria-controls="tab-panel-accounts"
          id="tab-accounts"
