...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        id="lang-select"
        className="text-xs border border-border rounded px-2 py-1 pr-8 bg-background text-foreground cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        value={locale}
