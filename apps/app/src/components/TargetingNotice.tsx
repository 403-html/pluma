  ...
  return (
    <div className="flex gap-2.5 rounded-md border border-blue-300 bg-blue-100 px-3 py-2.5 text-sm dark:border-blue-900 dark:bg-blue-950/40">
      ...
      <div className="flex-1 space-y-1">
        <p className="font-medium text-slate-900 dark:text-blue-200">{title}</p>
        <p className="text-slate-800 dark:text-blue-300">{body}</p>
        <code className="block rounded bg-blue-200 px-2 py-0.5 font-mono text-xs text-slate-900 dark:bg-blue-900/60 dark:text-blue-200">
          {codeSnippet}
        </code>
      </div>
      <button
