...
export default function TokenRevealBanner({
  ...
  return (
    <div
      role="alert"
      className="mb-6 rounded-lg border border-[#52796f] border-l-4 border-l-[#84a98c] bg-[#2f3e46] dark:border-emerald-700 dark:border-l-emerald-500 dark:bg-emerald-950/40 p-4"
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 rounded-md border border-[#52796f] dark:border-emerald-800 bg-[#354f52] dark:bg-emerald-950/60 px-3 py-2">
