export const en = {
  ...
  register: {
    ...
    description: "Join your organization's Pluma workspace.",
    emailLabel: 'Email',
    emailPlaceholder: 'you@example.com',
    passwordLabel: 'Password',
    passwordPlaceholder: '••••••••',
  ...
  settings: {
    ...
    toastPasswordPending: 'Changing password…',
  ...
  projects: {
    ...
    noEnvironments: '—',
    toastDeletePending: 'Deleting project…',
    toastDeleteSuccess: 'Project deleted',
    toastCreateSuccess: 'Project created',
    toastEditSuccess: 'Project saved',
  ...
  environments: {
    ...
    toastDeletePending: 'Deleting environment…',
    toastDeleteSuccess: 'Environment deleted',
    toastCreateSuccess: 'Environment created',
    toastEditSuccess: 'Environment saved',
  ...
  organization: {
    ...
    toastRevokePending: 'Revoking API key…',
    toastRevokeSuccess: 'API key revoked',
    toastCreateSuccess: 'API key created',
    ...
    domainSettings: {
      ...
      smtpSection: 'SMTP Server',
      smtpSectionDesc: 'Connection settings for outbound email delivery. Changes take effect immediately without restarting the server.',
      smtpHostLabel: 'SMTP host',
      smtpHostPlaceholder: 'mail.example.com',
      smtpPortLabel: 'Port',
      smtpSecureLabel: 'Use TLS (port 465)',
      smtpUserLabel: 'Username',
      smtpUserPlaceholder: 'user@example.com',
      smtpPassLabel: 'Password',
      smtpPassPlaceholder: 'Leave blank to keep current password',
      emailSection: 'Welcome Email',
      emailSectionDesc: 'Send a welcome email to users when they register. Requires SMTP to be configured above.',
      sendWelcomeEmailLabel: 'Send welcome email on registration',
      smtpFromLabel: 'From address',
      smtpFromPlaceholder: 'noreply@example.com',
      smtpFromDesc: 'Leave blank to use a default address derived from the SMTP host.',
    },
    accounts: {
      title: 'Accounts',
      desc: 'Manage user accounts in your organization.',
      colEmail: 'Email',
      colRole: 'Role',
      colStatus: 'Status',
      colActions: 'Actions',
      ...
      patchError: 'Failed to update account',
  ...
  flags: {
    ...
    loadingError: 'Failed to load flags',
