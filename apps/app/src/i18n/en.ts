export const en = {
  ...
  organization: {
    ...
    domainSettings: {
      ...
      emailSectionDesc: 'Send a welcome email to users when they register. Requires SMTP to be configured on the server.',
      ...
      smtpFromDesc: 'Leave blank to use the server-level SMTP_FROM setting.',
    },
    accounts: {
      title: 'Accounts',
